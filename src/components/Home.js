    ...
    render() {
        return (
            <div style={{marginBottom:100,marginTop:-10, paddingLeft:100,paddingTop:110}}>      
                <h2 style={{float:'left', paddingLeft:30,fontSize:'30px'}}><b> Newest games in our Storage</b></h2><br/><br/><br/>
                <div className="btn-group-vertical col-md-8 align-center"  style={{float:'center', paddingRight:120}}>
