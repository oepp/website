    ...
    render() {
        return (
            ...
            <div className="container" style={{paddingLeft:50,paddingTop:100}}>
                ...
                <div className ="card" style={{width:600,backgroundColor:"#E6E6FA",height:100, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}>Is OEPP free?</h3>
                <p style ={{fontSize:20}}>Learning on OEPP is not free. Our apps are available on Android, iOS, and Web.
                 ...
                 <div className= "card" style={{width:600,backgroundColor:"#E6E6FA",height:100, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}>Can I access OEPP courses offline?</h3>
                ...
                <div className= "card" style={{width:600,backgroundColor:"#E6E6FA",height:100, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}>How do I activate my account?</h3>
                ...
                <div className= "card" style={{width:600,backgroundColor:"#E6E6FA",height:100, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}>Is it possible to change my name on a profil?</h3>
                ...
                <div className= "card" style={{width:600,backgroundColor:"#E6E6FA",height:160, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}>How Do We Become Developers?</h3>
                ...
                <div className= "card" style={{width:600,backgroundColor:"#E6E6FA",height:160, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}>What Lessons Are Included In the OEPP Application?</h3>
                ...
                <div className= "card" style={{width:600,backgroundColor:"#E6E6FA",height:170, marginLeft:100}}>
                <h3 style ={{color:'#800000'}}> How to Create an Account?</h3>
