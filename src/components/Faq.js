    ...
    render() {
        return (
            ...
            <div className="container" style={{paddingLeft:50,paddingTop:100}}>
                ...
                <div className ="card" style={{width:800,backgroundColor:"#F2F2F2",height:150, paddingLeft:30,marginLeft:100}}>
                <h3 style ={{color:'#800000',fontWeight:'bold',paddingTop:15}}>Is OEPP free?</h3>
                <p style ={{fontSize:20}}>Learning on OEPP is free. Our apps are available on Android, iOS, and Web.
                ...
                <div className= "card" style={{width:800,backgroundColor:"#F2F2F2",height:200,paddingLeft:30, marginLeft:100}}>
                ...
                <div className= "card" style={{width:800,backgroundColor:"#F2F2F2",height:230,paddingLeft:30, marginLeft:100}}>
                ...
                <div className= "card" style={{width:800,backgroundColor:"#F2F2F2",height:190, marginLeft:100,paddingLeft:30}}>
                <h3 style ={{color:'#800000',fontWeight:'bold',paddingTop:15}}>What Lessons Are Included In the OEPP Application?</h3>
                <p style = {{fontSize:20}}>Depending on the wishes of the users there are courses in Software, Mathematics,English and many other fields.</p>
                </div>
